...
void priority_pree()
{
	...
	for (int i = 1; i<= n; i++) {
		cout << v[i][0] << "\t" << b_t[i] << " \t"  << v[i][2] << "\t" << c_t[i] << "\t" << c_t[i] -  v[i][0] << "\t" << c_t[i] -  v[i][0] - b_t[i] << endl;
	}
}
void priority_non()
{
	...
	for (int i = 1; i<= n; i++) {
		cout << v[i][0] << "\t" << v[i][1] << " \t"  << v[i][2] << "\t" << c_t[i] << "\t" << c_t[i]-v[i][0] << "\t" << c_t[i]-v[i][0]-v[i][1] << endl;
	}
}
void sjfs_pree()
{
	...
	for (int i = 1; i<= n; i++) {
		cout << v[i][0] << "\t" << b_t[i] << " \t" << c_t[i] << "\t" << c_t[i]- v[i][0] << "\t" << c_t[i]- v[i][0] - b_t[i] << endl;
	}
}
void fjfs()
{
